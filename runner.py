# -*- coding: utf-8 -*-
"""Adapting_programme_for_HPC.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1kTC_4WctnAxf78ctp2lmTLPsmzjO9q_n
"""
...
def set_environment(seed, llm_name):
    ...
    os.environ['HUGGINGFACE_HUB_TOKEN'] = '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'
...
def load_data():
    ...
    listen_log_df = pd.read_csv(testset_prehist_hists[0], nrows=50)
...
def create_oneshot_session_set(listen_log_df, N=2):
...
def run_and_save_experiments(seed, prompts, track_features_dict, model, llm, tokenizer, listen_log_df, majority_labels):
    results = {}
...
def main():
    ...
    # Import the data
    track_features_df, listen_log_df, testset_separate = load_data()
    ...
    track_features_dict, oneshot_sample_set, listen_log_df, dummy_train_data, majority_labels = initialize_data(track_features_df, testset_separate, listen_log_df)
    ...
    results = run_and_save_experiments(seed, prompts, track_features_dict, model, llm, tokenizer, listen_log_df, majority_labels)
